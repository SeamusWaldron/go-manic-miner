...
var helpLines = []HelpLine{
	...
	{"  SPEEDRUN", helpYellow},
	{"", 0},
	{"  Enable in Settings, pick", helpWhite},
	{"  Single or Overall mode.", helpWhite},
	{"  Single: ENTER opens warp", helpWhite},
	{"  picker; die = restart.", helpWhite},
	{"  Overall: ENTER starts run.", helpWhite},
	{"  During play: S = run this", helpWhite},
	{"  cavern. ESC ends the run.", helpWhite},
	{"", 0},
